...
class oDesk {
  ...
  private createClockFace(): HTMLElement {
    ...
    Object.assign(face.style, {
      ...
      padding: "60px 80px",
      boxShadow:
        "0 20px 60px rgba(0, 0, 0, 0.3), 0 0 0 10px rgba(255, 255, 255, 0.1), 0 0 0 20px rgba(255, 255, 255, 0.05)",
  ...
  private addAnimation(name: string, keyframes: string): void {
    const styleId = `oDesk-animation-${name}`;
