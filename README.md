...
- **应用管理界面**：提供可视化的技能应用管理平台，支持应用卡片展示和快速启动
  - **内置应用**：
    ...
    - **旅行计划 (Travel Plan)**：个性化旅行计划生成工具，支持多种视觉风格和图片类型
    - **电影搜索 (Movie Finder)**：电影搜索工具，快速查找感兴趣的电影
    - **诗词大师 (Ancien Poetry)**：探索诗词大师的生平与经典名句，感受传统文化魅力
    - **食谱图解 (Graphical Recipes)**：智能食谱生成工具，根据食材自动生成精美图解食谱，支持多种菜系风格
    - **有声书生成器 (Audio Book Creator)**：文本转语音工具，将文字内容转换为自然流畅的有声书
    - **AI文生图 (Text to Image)**：AI图片生成工具，输入文字描述生成高质量创意图片
    - **歌曲视频生成器 (Song Movie Generator)**：AI将歌曲自动转换为带歌词动画的音乐视频，支持快速生成宣传或分享内容
    - **网易云歌单视频生成器 (NetEase Playlist Video Generator)**：输入网易云歌单地址，下载歌曲并生成带有歌单内容的视频
    - **B站视频搜索下载器 (Bilibili Video Manager)**：搜索B站视频、管理下载队列并打包合集，便于批量整理内容
    - **音频剪辑 (Audio Cut)**：选择MP3文件进行音频裁剪，支持波形可视化、淡入淡出等剪辑处理
...
1. **Skill应用**：在"SKILL-APPS"标签页中，可以访问各种技能应用
   ...
   - **旅行计划**：输入目的地、天数等需求，AI生成个性化旅行计划，支持多种视觉风格
   - **电影搜索**：快速搜索电影信息，查找感兴趣的影视作品
   - **诗词大师**：探索古今诗词大师的生平事迹与经典名句，感受传统文化魅力
   - **食谱图解**：输入拥有的食材，AI自动生成详细食谱并附带精美步骤图解，支持多种菜系选择
   - **有声书生成器**：导入文本文件或粘贴内容，一键生成高品质有声读物，支持语速、音色调整
   - **AI文生图**：通过文字描述生成专业级创意图片，支持多种艺术风格、分辨率设置与批量生成
   - **歌曲视频生成器**：将歌曲内容转换为带歌词动画的音乐视频，适合生成宣传、分享或短视频内容
   - **网易云歌单视频生成器**：输入网易云歌单地址，下载歌曲并生成歌单视频
   - **B站视频搜索下载器**：搜索B站视频、管理下载队列并整合打包，便于收藏和整理视频内容
   - **音频剪辑**：加载MP3音频进行裁剪和处理，支持波形可视化、淡入淡出等编辑功能
